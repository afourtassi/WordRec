...
exp4_good_s <- exp4_good %>% filter(condition =='sound')
exp4_good_c <- exp4_good %>% filter(condition =='concept')
exp4_good_j <- exp4_good %>% filter(condition =='joint')

#Split data by subject 
data_by_subj_s <- split(exp4_good_s, exp4_good_s$ID) 
data_by_subj_c <- split(exp4_good_c, exp4_good_c$ID)
data_by_subj_j <- split(exp4_good_j, exp4_good_j$ID)
