...
///////////////////////////////////////////////
     ...
     var Joint_instructions= "In this part of the experiment, the other alien will be able to see the objects and hear the words.<br><br> You should help him decide if the second object is another "+first_obj+" '"+first_word+"-"+first_word+"' (by choosing 'same') or a "+second_obj+" '"+first_word+"-"+second_word+"' (by choosing 'different'). <br><br> <b> Remember that both the pictures and the sounds can be ambiguous. <br><br> To overcome these difficulties, you should base your decision on BOTH the sounds and the pictures.</b><br><br><b><font color='red'>IMPORTANT: Every situation is different, and the correct answer will change from one situation to another depending on both the sounds and the pictures, so do not base your answers on the pictures alone or the sounds alone.</b></font> <br><br> If you are not sure, use your intuition and give the answer that is more likely to be true!";

    var Sound_instructions= "In this part of the experiment, the other alien will only be able to hear the words, he will not be able to see the objects.<br><br> You should help him decide if the second object is another "+first_obj+" '"+first_word+"-"+first_word+"' (by choosing 'same') or a "+second_obj+" '"+first_word+"-"+second_word+"' (by choosing 'different'). <br><br> <b>Remember that the sounds can be ambiguous. To overcome this difficulty, you should base your decision on the similarity of the sounds.</b><br><br> If you are not sure, use your intuition and give the answer that is more likely to be true!";

    var Concept_instructions= "In this part of the experiment, the other alien will only be able to see the objects, he will not be able to hear the words.<br><br> You should help him decide if the second object is another "+first_obj+" (by choosing 'same') or a "+second_obj+" (by choosing 'different'). <br><br> <b>Remember that the pictures can be ambiguous. To overcome this difficulty, you should base your decision on the similarity of the pictures.</b><br><br> If you are not sure, use your intuition and give the answer that is more likely to be true!";


    var preJoint_instructions= "In this part of the training, the other alien will be able to see the objects and hear the words that his friend is saying.<br><br> You should help him decide if the second object is another "+first_obj+" '"+first_word+"-"+first_word+"' (by choosing 'same') or a "+second_obj+" '"+first_word+"-"+second_word+"' (by choosing 'different').";

    var preSound_instructions= "In this part of the training, the other alien will only be able to hear the words, he will not be able to see the objects.<br><br> You should help him decide if the second object is another "+first_obj+" '"+first_word+"-"+first_word+"' (by choosing 'same') or a "+second_obj+" '"+first_word+"-"+second_word+"' (by choosing 'different').";

    var preConcept_instructions= "In this part of the training, the other alien will only be able to see the objects, he will not be able to hear the words.<br><br> You should help him decide if the second object is another "+first_obj+" (by choosing 'same') or a "+second_obj+" (by choosing 'different')";
