...
var SounStim_noise = ['aba01_noise','aba03_noise','aba05_noise','aba07_noise', 'aba09_noise'];
...
var SounStim_noise = ['aba09_noise','aba07_noise','aba05_noise','aba03_noise', 'aba01_noise'];
...
for (i=0; i < SounStim.length; i++){
$sound_1.push($('<audio>').attr('src','sounds/'+SounStim_noise[i]+'.mp3').attr("preload", "auto"));
}
