...
var ConStim_blur = ['dog1_blur10','dog2_blur10','dog3_blur10','dog4_blur10', 'dog5_blur10'];
...
var ConStim_blur = ['dog5_blur10','dog4_blur10','dog3_blur10','dog2_blur10', 'dog1_blur10'];
var SounStim = ['aba01','aba03','aba05','aba07', 'aba09'];
...
for (i=0; i < ConStim_blur.length; i++){
$concept_1.push($('<img>').attr('src','images/'+ConStim_blur[i]+'.jpg').height(170).width(170));
}
